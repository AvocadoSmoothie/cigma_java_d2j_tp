...
public class TestList {
    ...
    private static void list1() {
        ...
        list1.add(23);
        list1.add(12);
        System.out.println("Affichage en utilisant la boucle for classique");
        for (int i = 0; i < list1.size(); i++) {
            Integer e = (Integer) list1.get(i);
            System.out.println(" element " + i + " : " + e);
        }
        System.out.println("Affichage en utilisant la boucle for avancée");
        for (Integer e : list1) {
            System.out.println(" element " + e);
        }
        System.out.println("Affichage en utilisant un iterator");
